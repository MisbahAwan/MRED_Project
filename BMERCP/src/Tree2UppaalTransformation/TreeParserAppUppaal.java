...
public class TreeParserAppUppaal {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Tree2UppaalLexer lexer = new Tree2UppaalLexer(input);
            CommonTokenStream tokens = new CommonTokenStream(lexer);
            Tree2UppaalParser parser = new Tree2UppaalParser(tokens);
            ParseTree tree = parser.system();

            // Instantiate visitor and trigger transformation
            TreeToUppaalVisitor visitor = new TreeToUppaalVisitor();
            //visitor.visit(tree);
