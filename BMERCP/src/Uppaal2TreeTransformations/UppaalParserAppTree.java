...
public class UppaalParserAppTree {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Uppaal2TreeLexer lexer = new Uppaal2TreeLexer(input);
            CommonTokenStream tokens = new CommonTokenStream(lexer);
            Uppaal2TreeParser parser = new Uppaal2TreeParser(tokens);
            ParseTree tree = parser.file();

            // Instantiate visitor and trigger transformation
            UppaalToTreeVisitor visitor = new UppaalToTreeVisitor();
            //visitor.visit(tree);
