...
public class TreeParserAppC {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Tree2CLexer lexer = new Tree2CLexer(input);
            CommonTokenStream tokens = new CommonTokenStream(lexer);
            Tree2CParser parser = new Tree2CParser(tokens);
            ParseTree tree = parser.system();

            // Instantiate visitor and trigger transformation
            TreeToCVisitor visitor = new TreeToCVisitor();
            //visitor.visit(tree);
