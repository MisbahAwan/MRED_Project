...
public class UppaalParserAppSystemVerilog {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Uppaal2SystemVerilogLexer lexer = new Uppaal2SystemVerilogLexer(input);
            CommonTokenStream tokens = new CommonTokenStream(lexer);
            Uppaal2SystemVerilogParser parser = new Uppaal2SystemVerilogParser(tokens);
            ParseTree tree = parser.file();

            // Instantiate visitor and trigger transformation
            UppaalToSystemVerilogVisitor visitor = new UppaalToSystemVerilogVisitor();
            //visitor.visit(tree);
            String CText = visitor.visit(tree);//visitor.getcCode();
