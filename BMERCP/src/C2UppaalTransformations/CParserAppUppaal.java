...
public class CParserAppUppaal {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            C2UppaalLexer lexer = new C2UppaalLexer(input);
            CommonTokenStream tokens = new CommonTokenStream(lexer);
            C2UppaalParser parser = new C2UppaalParser(tokens);
            ParseTree tree = parser.file();

            // Instantiate visitor and trigger transformation
            CToUppaalVisitor visitor = new CToUppaalVisitor();
            visitor.visit(tree);
